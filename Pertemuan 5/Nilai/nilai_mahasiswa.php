...
<form action="" method="post">
    ...
    <div> Nilai TS</div>
    <input type="text" name="ts" size="10" placehorder="0-100">
    <div> Nilai TM</div>
    <input type="text" name="tm" size="10" placehorder="0-100">
    <div> Nilai UTS</div>
    <input type="text" name="nilaiuts" size="10" placehorder="0-100">
    <div> Nilai UAS</div>
    <input type="text" name="nilaiuas" size="10" placehorder="0-100">
    <br><br>
